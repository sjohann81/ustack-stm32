...
#define htonll(n) ((1 == htonl(1)) ? (n) : (((uint64_t)htonl((n) & 0xFFFFFFFFUL)) << 32) | htonl((uint32_t)((n) >> 32)))
#define ntohll(n) ((1 == ntohl(1)) ? (n) : (((uint64_t)ntohl((n) & 0xFFFFFFFFUL)) << 32) | ntohl((uint32_t)((n) >> 32)))
